...
router.get("/", passport, (request, response, next) => {
    db.get().then(db => {
        ...
        query.order = sorting;
        query.select = [
            "_createdBy", "spinning", "date", "shift", "threadWeight", "goodCone", "badCone", "drum", "product.name","machine.name","lotMachine.lot","lotMachine.product.name","lotMachine.product.code"
        ];
        manager.read(query)
            .then(docs => {
